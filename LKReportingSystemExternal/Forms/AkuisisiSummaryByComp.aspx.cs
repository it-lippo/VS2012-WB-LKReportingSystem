...
{
    public partial class AkuisisiSummaryByComp : System.Web.UI.Page
    {
        protected static readonly ILog log = LogManager.GetLogger(typeof(AkuisisiSummaryByComp));
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            log.Info("AkuisisiSummaryByComp Page_Load().");
        ...
        protected void btnView_Click(object sender, EventArgs e)
        {
            ...
            string id = ws.InsertReportParameter(GetListBoxItem(lbxCompany), "", "", Constants.sessionUsername);

            Response.Redirect(Page.ResolveUrl("~/Lookup/Preview/ViewAkuisisiSummaryByComp.aspx?id=" + id + "&usr=" + Constants.sessionUsername));
        }
        ...
        protected void btnDownload_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string url = rooturl + "Lookup/Preview/ViewAkuisisiSummaryByComp.aspx?id=" + id + "&usr=" + Constants.sessionUsername;

                string fileConfig = "AkuisisiSummaryByCompany_" + DateTime.Now.ToString("yyyyMMdd") + ".pdf";
