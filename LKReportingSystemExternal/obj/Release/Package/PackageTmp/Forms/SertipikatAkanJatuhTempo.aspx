<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SertipikatAkanJatuhTempo.aspx.cs" Inherits="LKReportingSystemExternal.Forms.SertipikatAkanJatuhTempo" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Sertipikat Akan Jatuh Tempo</h1>
                </div>
            </div>
