...
{
    public partial class SertipikatAkanJatuhTempo : System.Web.UI.Page
    {
        protected static readonly ILog log = LogManager.GetLogger(typeof(SertipikatAkanJatuhTempo));
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            log.Info("SertipikatAkanJatuhTempo Page_Load().");
        ...
        {
            Response.Redirect(Page.ResolveUrl("~/Lookup/Preview/ViewSertipikatAkanJatuhTempo.aspx?usr=" + Constants.sessionUsername));
        }
        ...
        protected void btnDownload_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string url = rooturl + "Lookup/Preview/ViewSertipikatAkanJatuhTempo.aspx?usr=" + Constants.sessionUsername;

                string fileConfig = "SertipikatAkanJatuhTempo_" + DateTime.Now.ToString("yyyyMMdd") + ".pdf";
