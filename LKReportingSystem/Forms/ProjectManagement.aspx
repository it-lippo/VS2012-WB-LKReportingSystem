<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ProjectManagement.aspx.cs" Inherits="LKReportingSystem.Forms.ProjectManagement" %>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <asp:UpdatePanel ID="updatePanelHtmlNotification" UpdateMode="Conditional" runat="server" class="col-md-6">
                                            <ContentTemplate>
                                                <div><br /></div>

                                                <div class="col-md-6" id="htmlNotification" runat="server"></div>
                                            </ContentTemplate>
                                        </asp:UpdatePanel>
