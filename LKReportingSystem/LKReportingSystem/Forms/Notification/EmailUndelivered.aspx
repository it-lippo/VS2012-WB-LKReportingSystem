<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EmailUndelivered.aspx.cs" Inherits="LKReportingSystem.Forms.Notification.EmailUndelivered" %>
        ...
        <asp:UpdatePanel ID="upTransactionUnit" runat="server">
            <ContentTemplate>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Report <small>Undelivered Email</small>
                            </h1>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <button type="button" id="btnDisplayModal" style="visibility:hidden" class="form-control btn btn-info col-sm-5 col-xs-12" data-toggle="modal" data-target="#viewEmailModal">View</button>
                                    ...
                                    <asp:GridView ID="gvReportUndeliv" EmptyDataText="No Data Available" CssClass="footable" runat="server" EnableViewState="true"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="emailsubject" HeaderText="Subject" ItemStyle-Font-Size="11px" />
                                            <asp:BoundField DataField="sentTime" HeaderText="Sent Time"  ItemStyle-Font-Size="11px" />
                                            <asp:BoundField DataField="emailAddress" HeaderText="Email" ItemStyle-Font-Size="11px"/>

                                            <asp:TemplateField HeaderText="View">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lbViewContentEmail" runat="server" CssClass="form-control btn btn-info col-sm-5 col-xs-12" CommandName="ContentEmail" CommandArgument='<%#Eval("notifcode")%>'><i class="fa fa-eye" ></i>&nbsp;Content</asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                ...
                <div class="modal" id="viewEmailModal" role="dialog">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    <div style="width: 100%; overflow:auto">
                                        <asp:Literal ID="ltContentEmail" runat="server"></asp:Literal>
                                    </div>
                                </div>
                            </div>
