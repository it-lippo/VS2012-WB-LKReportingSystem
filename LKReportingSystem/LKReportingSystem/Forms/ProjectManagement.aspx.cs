...
namespace LKReportingSystem.Forms
{
    ...
    {
        protected static readonly ILog log = LogManager.GetLogger(typeof(ProjectManagement));
        ...
        //        int batchid = clsSalesSummary.GenerateSalesSummary(projectcode, clustercode, asofdate, Constants.sessionUsername);
        ...
        //            clsSalesSummary.UpdateActualCost(_DT_CostContractProjectMapping, Constants.sessionUsername);
        ...
        protected void gvDataSalesSummary_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                if (!clsSecurity.HaveAccess("~/Lookup/Preview/ViewSalesSummary.aspx"))
                {
                    htmlNotificationHistory.InnerHtml = "<button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-hidden=\"true\">x</button>"
                        + "<i class=\"fa fa-info-circle\"> </i>"
                        + "<Strong> Warning! </Strong> You Have No Permission To View Sales Summary Page";
                ...
                DataTable dt = clsSalesSummary.GetDataDetailSalesReport(e.CommandArgument.ToString());
                if (dt.Rows.Count > 0)
                {
                    ...
                    if (errorChecker)
                    {
                        ScriptManager.RegisterStartupScript(this.Page, this.Page.GetType(), "err_msg", "bootbox.alert({title:'Oops!', message:'<strong>[Initial Budget]</strong> - Following Field Cannot Be Zero or Empty: <ul> <li>No Of Unit</li> <li>M2 (SGA)</li> <li>Rp/M2 (SGA) (Revenue)</li> <li>Land Cost/M2</li> <li>Const Cost/M2</li> <ul>'});", true);
                    }
                    else {
            ...
            {
                if (!clsSecurity.HaveAccessAction(this.AppRelativeVirtualPath, "print"))
                {
                    htmlNotificationHistory.InnerHtml = "<button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-hidden=\"true\">x</button>"
                            + "<i class=\"fa fa-info-circle\"> </i>"
                            + "<Strong> Warning! </Strong> You Have No Permission To Download Sales Summary Page";
        ...
        protected void btnProjectSetup_Click(object sender, EventArgs e)
        {
            ...
            {
                ScriptManager.RegisterStartupScript(this.Page, this.Page.GetType(), "err_msg", "bootbox.alert({message:'Please select project for salary setup.', title:'Oops!'});", true);
        ...
        protected void btnSalarySetup_Click(object sender, EventArgs e)
        {
            ...
            if (Session["ProjectCode"] != null)
            {
                ...
                if (!clsSecurity.HaveAccess("~/Forms/ProjectSalarySetup.aspx"))
                {
                    htmlNotification.InnerHtml = "<button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-hidden=\"true\">x</button>"
                        + "<i class=\"fa fa-info-circle\"> </i>"
                        + "<Strong> Warning! </Strong> You Have No Permission To View Salary Setup Page";

                    htmlNotification.Attributes.Add("class", "alert alert-danger alert-dismissable");
                    updatePanelHtmlNotification.Update();
                    return;
                }
        ...
        protected void btnInitialBudget_Click(object sender, EventArgs e)
        {
            if (Session["ProjectCode"] != null)
            {
                ...
                if (!clsSecurity.HaveAccess("~/Forms/InitialBudgetSetup.aspx"))
                {
                    htmlNotification.InnerHtml = "<button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-hidden=\"true\">x</button>"
                        + "<i class=\"fa fa-info-circle\"> </i>"
                        + "<Strong> Warning! </Strong> You Have No Permission To View Initial Budget Setup Page";
            ...
            {
                ScriptManager.RegisterStartupScript(this.Page, this.Page.GetType(), "err_msg", "bootbox.alert({message:'Please select project for Initial Budget setup.', title:'Oops!'});", true);
        ...
        protected void btnConstructionCost_Click(object sender, EventArgs e)
        {
            if (Session["ProjectCode"] != null)
            {
                ...
                if (!clsSecurity.HaveAccess("~/Forms/ConstructionCostSetup.aspx"))
                {
                    htmlNotification.InnerHtml = "<button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-hidden=\"true\">x</button>"
                        + "<i class=\"fa fa-info-circle\"> </i>"
                        + "<Strong> Warning! </Strong> You Have No Permission To View Construction Cost Setup Page";
            ...
            {
                ScriptManager.RegisterStartupScript(this.Page, this.Page.GetType(), "err_msg", "bootbox.alert({message:'Please select project for Construction Cost setup.', title:'Oops!'});", true);
        ...
        protected void btnCashflowSetup_Click(object sender, EventArgs e)
        {
            if (Session["ProjectCode"] != null)
            {
                ...
                if (!clsSecurity.HaveAccess("~/Forms/CashFlowSetup.aspx"))
                {
                    htmlNotification.InnerHtml = "<button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-hidden=\"true\">x</button>"
                        + "<i class=\"fa fa-info-circle\"> </i>"
                        + "<Strong> Warning! </Strong> You Have No Permission To View Cash Flow Setup Page";
            ...
            {
                ScriptManager.RegisterStartupScript(this.Page, this.Page.GetType(), "err_msg", "bootbox.alert({message:'Please select project for Cash Flow setup.', title:'Oops!'});", true);
