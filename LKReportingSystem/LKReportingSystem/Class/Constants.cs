...
namespace LKReportingSystem.Class
{
    ...
    {
        public const string domainName = "BYPASS";
        public const string username = "usrBypass";
        public const string password = "L1pp0!";
        ...
        public static string LandedCategory = ConfigurationManager.AppSettings["LandedCategory"];
        public static string ApartmentCategory = ConfigurationManager.AppSettings["ApartmentCategory"];
        public static string DefaultProject = ConfigurationManager.AppSettings["DefaultProject"];
        ...
        public static string[] AppID = new string[] { "APP00205" };
